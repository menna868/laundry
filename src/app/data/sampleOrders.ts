...
export const sampleOrders: Order[] = [
  {
    ...
    laundryImage: 'https://images.unsplash.com/photo-1764120656278-994739787d38?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&q=80&w=400',
    serviceId: 'wash-kg',
  ...
  },
  {
    ...
    laundryImage: 'https://images.unsplash.com/photo-1695679958326-918405eacb70?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&q=80&w=400',
    serviceId: 'dry-shirt',
  ...
  },
  {
    ...
    laundryImage: 'https://images.unsplash.com/photo-1761079976271-3a78f547ca67?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&q=80&w=400',
...
export const statusConfig: Record<OrderStatus, { label: string; color: string; bg: string; description: string }> = {
  pending_confirmation: {
  ...
  accepted: {
    ...
    color: '#1D6076',
    bg: '#EFF8FB',
    description: 'The laundry has accepted your order and is preparing for pickup.',
  },
  washing: {
    label: 'Being Washed',
    color: '#2a7a94',
