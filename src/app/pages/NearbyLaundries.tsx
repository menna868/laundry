...
import {
  ...
  Navigation, AlertCircle, WifiOff, RefreshCw, ChevronRight, Zap
} from 'lucide-react';
...
function PermissionScreen({ onGrant, onDeny }: { onGrant: () => void; onDeny: () => void }) {
  return (
    <div className="flex flex-col items-center justify-center flex-1 px-6 py-12 text-center">
      ...
      <p className="text-gray-500 text-base leading-relaxed mb-8 max-w-xs">
        Nadeef needs your location to show nearby laundries, distances, and real-time availability.
      </p>
      <button
        onClick={onGrant}
...
function FetchingScreen() {
  return (
    <div className="flex flex-col items-center justify-center flex-1 px-6 py-12 text-center">
      ...
      <p className="text-gray-400 text-sm">Fetching active services in your area</p>
...
function ErrorScreen({
  ...
  return (
    <div className="flex flex-col items-center justify-center flex-1 px-6 py-12 text-center">
      ...
      <p className="text-gray-500 text-sm leading-relaxed mb-8 max-w-xs">{body}</p>
      <button
        onClick={onRetry}
      ...
      >
        ...
        <div className="px-4 py-4">
          <div className="flex items-start justify-between mb-2">
            <h3 className="text-gray-900 text-base font-medium leading-snug">{laundry.name}</h3>
            <ChevronRight size={18} className="text-gray-300 mt-0.5 shrink-0" strokeWidth={2} />
          </div>
          ...
          <div className="flex items-center gap-3">
            ...
            <span className="w-1 h-1 rounded-full bg-gray-300" />
            <span className={`text-xs font-medium ${laundry.isAvailable ? 'text-emerald-600' : 'text-gray-400'}`}>
  ...
  return (
    <div className="min-h-screen bg-[#f5f5f5] flex flex-col" dir="ltr">
      ...
      {flowState === 'permission_request' && (
        <PermissionScreen onGrant={handleGrantPermission} onDeny={handleDenyPermission} />
      )}
        ...
        <div className="flex-1 max-w-3xl mx-auto w-full px-4 md:px-8 py-5 space-y-4">
          ...
          {showFilters && (
            <div className="bg-white rounded-2xl border border-gray-100 shadow-sm p-4 space-y-4">
              {/* Sort */}
              <div>
                <p className="text-xs font-semibold text-gray-500 tracking-wider mb-2.5">SORT BY</p>
              ...
              {/* Availability */}
              <div>
                <p className="text-xs font-semibold text-gray-500 tracking-wider mb-2.5">AVAILABILITY</p>
                <div className="flex gap-2">
