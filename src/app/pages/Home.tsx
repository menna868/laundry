...
const HERO_IMG =
  "https://images.unsplash.com/photo-1596433904747-e8b061219a71?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&q=80&w=1400";
const DELIVERY_IMG =
  "https://images.unsplash.com/photo-1576192350050-d9e08ee1f122?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&q=80&w=800";
const WASHING_IMG =
  "https://images.unsplash.com/photo-1631323272727-6418cf55f287?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&q=80&w=800";

const steps = [
  {
    n: "01",
    title: "Find a Laundry",
    desc: "Browse verified laundries near your location, compare prices and ratings.",
    icon: MapPin,
    color: "#1D6076",
    bg: "#EFF8FB",
  },
  {
    ...
    desc: "Choose services, set a pickup time, and confirm your order in seconds.",
    icon: Sparkles,
    color: "#EBA050",
    bg: "#FFF7ED",
  },
  {
    n: "03",
    title: "Track & Receive",
    desc: "Follow your order in real time and receive your clean clothes at your door.",
    icon: CheckCircle,
    color: "#059669",
    bg: "#ECFDF5",
  },
...
const features = [
  {
    icon: ShieldCheck,
    title: "Verified Laundries",
    desc: "Every partner laundry is vetted for quality and reliability.",
    color: "#1D6076",
  },
  {
    icon: Clock,
    title: "Smart Scheduling",
    desc: "Pick a time slot that suits you — no waiting, no surprises.",
    color: "#EBA050",
  },
  {
    icon: Zap,
    title: "Real-Time Tracking",
    desc: "Know exactly where your order is at every step of the process.",
    color: "#059669",
  },
  {
    icon: Star,
    title: "Transparent Pricing",
    desc: "See exact costs before you order — no hidden fees, ever.",
    color: "#7c3aed",
  },
];
...
const testimonials = [
  {
    ...
    role: "New Cairo",
    rating: 5,
    text: "Nadeef saved me so much time. My clothes come back perfectly clean every single time!",
  },
  {
    name: "Ahmed Tarek",
    role: "Maadi",
    rating: 5,
    text: "The tracking feature is a game-changer. I always know when to expect my delivery.",
  },
  {
    name: "Sara Mansour",
    role: "Zamalek",
    rating: 5,
    text: "Best laundry service in Cairo by far. Affordable, fast, and professional.",
  },
];
...
export default function Home() {
  ...
  const handleLaundryClick = (laundryId: string) => {
    const destination = `/laundry/${laundryId}`;

    if (!isLoggedIn) {
      if (typeof window !== "undefined") {
        window.localStorage.setItem(POST_LOGIN_REDIRECT_KEY, destination);
      }
      router.push(`/login?from=${encodeURIComponent(destination)}`);
      return;
    }
  ...
  return (
    <div className="min-h-screen overflow-x-clip" dir="ltr">
      {/* ── HERO ──────────────────────────────────────────────────────────── */}
      <section className="relative flex min-h-screen items-center overflow-hidden bg-[#0d3d50]">
        {/* Background image */}
        <div className="absolute inset-0">
          ...
          />
          <div className="absolute inset-0 bg-linear-to-br from-[#0d3d50] via-[#1D6076]/90 to-[#0d3d50]/80" />
          {/* Animated blobs */}
          <motion.div
        ...
        <div className="relative mx-auto grid max-w-7xl grid-cols-1 items-center gap-12 px-4 pb-20 pt-28 md:px-8 md:pb-28 md:pt-36 lg:grid-cols-[1.05fr_.95fr]">
          {/* Left — copy */}
          <div className="text-center md:text-left">
            {isLoggedIn && user && (
              <motion.div
                ...
                className="mx-auto inline-flex items-center gap-2 rounded-full border border-white/20 bg-white/10 px-4 py-1.5 backdrop-blur-sm md:mx-0 mb-6"
              >
            ...
            <motion.h1
              ...
              className="mx-auto mb-6 max-w-3xl text-4xl leading-tight text-white md:text-5xl lg:text-6xl md:mx-0"
            ...
            <motion.p
              ...
              className="mx-auto mb-8 max-w-xl text-lg leading-relaxed text-white/75 md:text-xl md:mx-0"
            >
              Ndeef connects you with the best local laundries. Browse, order,
              track — clean clothes at your door.
            </motion.p>
          ...
          <div className="hidden items-center justify-center md:flex">
            <motion.div
              className="relative w-88 max-w-full"
            ...
            >
              ...
              <div className="bg-white rounded-3xl p-6 shadow-2xl">
                ...
                <div className="space-y-2">
                  {["Wash & Fold", "Dry Cleaning", "Ironing Service"].map(
                    (s, i) => (
                      <motion.div
                        key={s}
                      ...
                      >
                        ...
                        <span className="text-xs font-semibold text-[#1D6076]">
                          {["18", "45", "8"][i]} EGP
                        </span>
                      </motion.div>
                    ),
              ...
              <motion.div
                className="absolute -top-4 -right-4 bg-linear-to-br from-[#EBA050] to-[#d4832a] text-white rounded-2xl px-4 py-2 shadow-lg text-xs font-semibold"
                animate={{ y: [0, -6, 0] }}
                transition={{
                  duration: 3,
                  repeat: Infinity,
                ...
                >
                  <div className="flex items-start gap-4 mb-5">
                    ...
                    <span
                      ...
                      style={{ color: `${color}15`, lineHeight: 1 }}
                    >
                      {n}
                    </span>
                  </div>
      ...
      >
        <div className="max-w-7xl mx-auto px-4 md:px-8">
          <div className="mb-10 flex items-end justify-between gap-4">
            ...
            <Link
              href="/nearby"
              className="flex items-center gap-1.5 text-sm font-semibold text-[#EBA050] transition-all hover:gap-2.5"
            >
            ...
            {nearbyPreview.length > 0 ? (
              nearbyPreview.map((l) => (
                <motion.div key={l.id} variants={itemVariants}>
                  <button
                    type="button"
                    onClick={() => handleLaundryClick(l.id)}
                      ...
                      <div className="p-5">
                        ...
                        <div className="flex items-center justify-between">
                          <span className="text-xs text-gray-500">
                            From{" "}
                            <strong className="text-[#1D6076]">
                              {l.services.length
                                ? Math.min(...l.services.map((s) => s.price))
                                : 0}{" "}
                              EGP
                            </strong>
                          </span>
              ...
              >
                <p className="text-white text-lg font-semibold mb-2">
                  No live laundries yet
                </p>
                <p className="text-white/65 text-sm max-w-md mx-auto">
                  The deployed backend is connected, but it is currently
                  returning an empty laundries list.
                </p>
              </motion.div>
            )}
          </motion.div>
        ...
        <div className="max-w-7xl mx-auto px-4 md:px-8">
          <div className="grid md:grid-cols-2 gap-12 items-center mb-16">
            ...
            >
              ...
              <h2
                className="text-3xl md:text-4xl text-gray-900 mb-5"
                style={{ fontWeight: 800, letterSpacing: "-0.02em" }}
              >
              ...
              <p className="text-gray-500 text-base leading-relaxed max-w-md">
                We solve the chaos of informal laundry communication by bringing
                transparency, speed, and accountability to your doorstep.
              </p>
            </motion.div>
            <motion.div
            ...
            >
              <ImageWithFallback
                ...
                className="h-full w-full object-cover object-center"
              />
              <div className="absolute inset-0 bg-linear-to-br from-[#1D6076]/30 to-transparent" />
            </motion.div>
          </div>
            ...
            {testimonials.map(({ name, role, rating, text }) => (
              ...
              >
                ...
                <div className="flex items-center gap-3">
                  <div className="w-9 h-9 rounded-full bg-linear-to-br from-[#1D6076] to-[#2a7a94] flex items-center justify-center">
                    <span className="text-white text-xs font-semibold">
                      {name[0]}
                    </span>
                  </div>
      ...
      <Section
        className="py-20"
        style={{
          background: "linear-gradient(135deg, #EBA050 0%, #d4832a 100%)",
        }}
      >
        ...
        <div className="max-w-7xl mx-auto px-4 md:px-8">
          <div className="grid sm:grid-cols-2 md:grid-cols-4 gap-8 mb-10">
            <div>
              ...
              <p className="text-white/50 text-sm leading-relaxed">
                Smart laundry platform connecting residents with local laundries
                in Egypt.
              </p>
            </div>
            {[
              ...
              {
                heading: "Account",
                links: ["Sign In", "Register", "Profile", "Preferences"],
              },
              {
                heading: "Support",
                links: [
              ...
              <div key={heading}>
                ...
                <ul className="space-y-2.5">
                  {links.map((l) => (
                    <li key={l}>
                      <span className="text-white/45 text-sm hover:text-white/80 cursor-pointer transition-colors">
                        {l}
                      </span>
                    </li>
                  ))}
          ...
          <div className="border-t border-white/10 pt-8 flex flex-col md:flex-row items-center justify-between gap-4">
            <p className="text-white/30 text-sm">
              © 2026 Ndeef. All rights reserved.
            </p>
