...
export default function OrderPage() {
  ...
  useEffect(() => {
    ...
    if (!isLoggedIn) {
      const from = encodeURIComponent(
        `/order/${laundryId}?service=${serviceId}`,
      );
      router.replace(`/login?from=${from}`);
    }
  }, [isAuthReady, isLoggedIn, laundryId, router, serviceId]);
  ...
  const handlePlaceOrder = async () => {
    ...
    const pendingOrder: Order = {
      ...
      laundryImage:
        typeof laundry.image === "string" ? laundry.image : laundry.image?.src,
            ...
            <div className="flex items-start gap-3">
              ...
              <div className="flex-1">
                ...
                <p className="text-red-600 text-xs mt-0.5">
                  The selected service is not available at this time. Please
      ...
      <div className="max-w-2xl mx-auto px-4 md:px-8 py-5 space-y-4">
          ...
          {serviceError && (
            <div className="mt-3 flex items-center gap-2 bg-red-50 rounded-xl px-3 py-2.5">
              ...
              <p className="text-red-600 text-xs">
                Selected service is no longer available. Please go back and
                choose another.
              </p>
            </div>
          )}
        ...
        <div className="bg-white rounded-2xl border border-gray-100 shadow-sm p-5">
          ...
          <div className="flex items-center justify-between bg-gray-50 rounded-2xl px-6 py-4">
            ...
            <div className="text-center">
              <p
                className="text-4xl text-[#1D6076]"
        ...
        <div className="bg-white rounded-2xl border border-gray-100 shadow-sm p-5">
          ...
          <div className="flex items-center justify-between mt-4">
            ...
            >
              <span
                className={`absolute top-1 w-4 h-4 bg-white rounded-full shadow transition-transform ${sameAddress ? "translate-x-7" : "translate-x-1"}`}
              />
            </button>
          </div>
        </div>
        ...
        <div className="bg-white rounded-2xl border border-gray-100 shadow-sm p-5">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-3">
            ...
            >
              ...
              <p className="text-xs text-gray-500">Continue to secure card payment.</p>
            </button>
          </div>
        </div>
