...
export default function TrackOrder() {
  ...
  const canCancelOrder =
    order &&
    (order.status === "pending_confirmation" || order.status === "accepted");
    ...
    <div className="min-h-screen bg-[#f5f5f5]" dir="ltr">
      ...
      {flowState === "invalid" && (
        <div className="flex flex-col items-center justify-center min-h-[60vh] px-8 text-center">
          ...
          <p className="text-gray-500 text-sm mb-7 max-w-xs">
            The order ID is not valid. Please check the link and try again.
          </p>
          <Link
            href="/orders"
      ...
      {flowState === "access_denied" && (
        <div className="flex flex-col items-center justify-center min-h-[60vh] px-8 text-center">
          ...
          <p className="text-gray-500 text-sm mb-7">
            You don&apos;t have permission to view this order. It belongs to a
            different account.
          </p>
          <Link
            href="/orders"
        ...
        <div className="max-w-2xl mx-auto px-4 md:px-8 py-5 space-y-4 pb-10">
          ...
          >
            <div className="flex items-start gap-3">
              ...
              >
                {(() => {
                  const I = StatusIcon[order.status];
                  return (
                    <I
                      size={22}
          ...
          <div className="bg-white rounded-2xl border border-gray-100 shadow-sm p-5">
            ...
            <div className="space-y-3">
              {[
                ...
                {
                  label: "Items",
                  value: `${order.itemCount} ${order.serviceUnit}`,
                },
                {
                  label: "Pickup",
          ...
          {canCancelOrder && (
            <button
              ...
              className="block w-full bg-red-300 hover:bg-red-400 hover:cursor-pointer text-red-600 border border-red-200 rounded-2xl py-4 px-5 text-sm font-semibold transition-all active:scale-[0.99]"
            >
              Cancel Order
            </button>
          )}
      ...
      {showCancelModal && (
        <div className="fixed inset-0 bg-black/50 flex items-end z-50">
          <div className="w-full bg-white rounded-t-3xl p-5 pb-8 shadow-xl animation-in slide-in-from-bottom">
            <div className="max-w-2xl mx-auto">
              ...
              <div className="flex items-start justify-between mb-5">
                ...
                <button
                  ...
                  className="p-2 -mr-2 -mt-2 rounded-xl hover:bg-gray-100 transition-colors"
                >
                  <XCircle
                    size={22}
              ...
              {/* Modal content */}
              <div className="bg-red-100 rounded-2xl p-4 mb-6 border border-red-100">
                <p className="text-sm text-gray-700">
                  Are you sure you want to cancel this order? You can only
                  cancel orders that haven&apos;t started processing yet.
                </p>
              </div>
              ...
              {order && (
                <div className="bg-gray-50 rounded-2xl p-4 mb-6">
                  <p className="text-xs text-gray-500 tracking-wider font-semibold mb-3">
                    REFUND
                  </p>
                  <div className="flex justify-between items-center">
                    <span className="text-sm text-gray-700">
                      Full refund will be issued to your account
                    </span>
              ...
              <div className="flex gap-3">
                <button
                  ...
                  className="flex-1 px-6 py-3 rounded-2xl text-sm font-semibold bg-gray-100 text-gray-900 hover:bg-gray-200 transition-all disabled:opacity-50"
                >
                  Keep Order
                </button>
                <button
                  ...
                  disabled={isCancelling}
                  className="flex-1 px-6 py-3 rounded-2xl text-sm font-semibold bg-red-500 text-white hover:bg-red-700 active:scale-[0.98] transition-all disabled:opacity-50 flex items-center justify-center gap-2"
                >
                  {isCancelling ? (
                    <>
