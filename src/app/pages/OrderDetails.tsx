...
export default function OrderDetails() {
  ...
  return (
    <div className="min-h-screen overflow-x-clip bg-[#f8fafb] pb-20" dir="ltr">
      {/* Header */}
      <div className="bg-linear-to-br from-[#1D6076] to-[#2a7a94] text-white px-4 md:px-8 lg:px-12 py-6 md:py-8">
      ...
      <div className="mx-auto max-w-6xl">
        ...
        <motion.div
          ...
          className="mb-4 border-b border-gray-100 bg-white px-4 py-6 md:px-8 md:py-8 lg:px-12"
        >
          <h2 className="mb-6 text-center text-base font-semibold text-gray-900 md:mb-8 md:text-xl">
            Order Status
          </h2>
          <OrderStatusTracker currentStatus={order.status} />
          <div className="mt-4 rounded-xl bg-[#1D6076]/10 p-4 md:mt-6 md:p-5">
            <p className="text-center text-sm font-normal text-gray-700 md:text-base">
        ...
        <motion.div
          ...
          className="mx-4 mb-4 rounded-2xl border border-gray-100 bg-white px-5 py-5 shadow-sm md:mx-8 md:px-6 md:py-6 lg:mx-12"
        >
          <h3 className="mb-4 text-base font-semibold text-gray-900 md:mb-6 md:text-xl">
            Order Information
          </h3>
          <div className="space-y-3 md:space-y-4">
            ...
            <div className="flex items-center justify-between py-2.5 md:py-3">
              ...
              <span className="font-bold text-[#1D6076] text-lg md:text-2xl">
                {order.total} EGP
              </span>
            </div>
          </div>
        ...
        <div className="px-4 md:px-8 lg:px-12 mb-4">
          <h3 className="mb-3 text-base font-semibold text-gray-900 md:mb-4 md:text-xl">
            Quick Actions
          </h3>
          <div className="grid grid-cols-3 gap-3 md:gap-4">
            <button className="flex flex-col items-center gap-2 rounded-xl border border-gray-100 bg-white p-4 shadow-sm transition-all hover:-translate-y-0.5 hover:bg-gray-50 md:gap-3 md:p-6">
            ...
            <button className="flex flex-col items-center gap-2 rounded-xl border border-gray-100 bg-white p-4 shadow-sm transition-all hover:-translate-y-0.5 hover:bg-gray-50 md:gap-3 md:p-6">
              <div className="w-11 h-11 md:w-14 md:h-14 bg-[#1D6076]/10 rounded-xl flex items-center justify-center">
                <Share2
                  size={22}
                  className="text-[#1D6076] md:w-7 md:h-7"
                  strokeWidth={2}
                />
              </div>
              <span className="text-xs md:text-sm font-medium text-center text-gray-700">
        ...
        {order.status === "ready" || order.status === "delivered" ? (
          <div className="mx-4 mb-4 rounded-2xl border border-gray-100 bg-white px-5 py-5 shadow-sm md:mx-8 md:px-6 md:py-6 lg:mx-12">
            <h3 className="mb-4 text-base font-semibold text-gray-900 md:mb-6 md:text-xl">
            ...
            <div className="flex items-start gap-3 md:gap-4 mb-4 md:mb-5">
              <div className="w-9 h-9 md:w-11 md:h-11 rounded-lg bg-[#EBA050]/10 flex items-center justify-center shrink-0 mt-0.5">
                <MapPin
                  size={18}
                  className="text-[#EBA050] md:w-6 md:h-6"
                  strokeWidth={2}
                />
              </div>
              <div>
                <p className="font-medium mb-1 text-gray-900 text-sm md:text-base">
                  Delivery Address
                </p>
                <p className="text-sm md:text-base text-gray-600 font-normal">
                  Home - University Street, 3rd Floor
                </p>
              </div>
            </div>
            <div className="flex items-start gap-3 md:gap-4">
              <div className="w-9 h-9 md:w-11 md:h-11 rounded-lg bg-[#1D6076]/10 flex items-center justify-center shrink-0 mt-0.5">
                <Clock
                  size={18}
                  className="text-[#1D6076] md:w-6 md:h-6"
                  strokeWidth={2}
                />
              </div>
              <div>
