      ...
      <div className="fixed inset-y-0 left-0 w-80 md:w-96 bg-white z-50 shadow-xl overflow-y-auto" dir="ltr">
        <div className="p-5 md:p-8">
          ...
          <div className="space-y-1 mb-8 md:mb-10">
            <Link to="/" onClick={onClose} className="flex items-center gap-4 px-3 py-4 md:py-5 text-gray-900 hover:bg-gray-50 rounded-lg transition-colors">
              <Home size={20} className="text-gray-700 md:w-6 md:h-6" strokeWidth={2} />
              <span className="text-base md:text-lg">Home</span>
            </Link>

            <Link to="/profile" onClick={onClose} className="flex items-center gap-4 px-3 py-4 md:py-5 text-gray-900 hover:bg-gray-50 rounded-lg transition-colors">
              <User size={20} className="text-gray-700 md:w-6 md:h-6" strokeWidth={2} />
              <span className="text-base md:text-lg">Profile</span>
            </Link>

            <Link to="/services" onClick={onClose} className="flex items-center gap-4 px-3 py-4 md:py-5 text-gray-900 hover:bg-gray-50 rounded-lg transition-colors">
            ...
            <Link to="/rinse-repeat" onClick={onClose} className="flex items-center gap-4 px-3 py-4 md:py-5 text-gray-900 hover:bg-gray-50 rounded-lg transition-colors">
              <Package size={20} className="text-gray-700 md:w-6 md:h-6" strokeWidth={2} />
              <span className="text-base md:text-lg">Rinse Repeat</span>
            </Link>

            <Link to="/preferences" onClick={onClose} className="flex items-center gap-4 px-3 py-4 md:py-5 text-gray-900 hover:bg-gray-50 rounded-lg transition-colors">
              <Sliders size={20} className="text-gray-700 md:w-6 md:h-6" strokeWidth={2} />
              <span className="text-base md:text-lg">Preferences</span>
            </Link>

            <Link to="/billing" onClick={onClose} className="flex items-center gap-4 px-3 py-4 md:py-5 text-gray-900 hover:bg-gray-50 rounded-lg transition-colors">
              <CreditCard size={20} className="text-gray-700 md:w-6 md:h-6" strokeWidth={2} />
              <span className="text-base md:text-lg">Billing</span>
            </Link>

            <Link to="/order-history" onClick={onClose} className="flex items-center gap-4 px-3 py-4 md:py-5 text-gray-900 hover:bg-gray-50 rounded-lg transition-colors">
              <Clock size={20} className="text-gray-700 md:w-6 md:h-6" strokeWidth={2} />
              <span className="text-base md:text-lg">Order History</span>
            </Link>

            <Link to="/help" onClick={onClose} className="flex items-center gap-4 px-3 py-4 md:py-5 text-gray-900 hover:bg-gray-50 rounded-lg transition-colors">
